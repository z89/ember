...
changing mode fades the screen over 0.8s instead of snapping. the length is under the plugin's settings, 0 for instant. only changes made through ember fade; the gamma tab and `dms ipc call night` still snap.
